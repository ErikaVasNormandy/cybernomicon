...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/asci-blue/Workspace/cybernomicon/0-basic-spells/scheduler'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/asci-blue/Workspace/cybernomicon/0-basic-spells/scheduler/bin/deactivate.nu'
