...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/asci-blue/Workspace/cybernomicon/basic-spells/smallest-scraper'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/asci-blue/Workspace/cybernomicon/basic-spells/smallest-scraper/bin/deactivate.nu'
